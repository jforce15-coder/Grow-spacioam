/* Spacio AM · Cliente de auth unificado — GROW
...
(function (global) {
  ...
  var SAAuth = {
    APP: 'grow',   // clave de ESTA app en el perfil (r.profile.apps['grow'])
    ...
    /* Propietarios y socios de toda la hoja, sin filtrar por app. */
    owners:             function ()                { return call('owners', {}); },
